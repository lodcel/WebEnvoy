...
- 与 Syvert：该 contract 不包含 Syvert normalized result、业务 schema、project state 或 product workflow。
...
5. PR metadata 使用 `Fixes #1123`，并声明 integration 为 local-only。
