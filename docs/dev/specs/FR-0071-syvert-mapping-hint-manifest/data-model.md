...
- `allowed_effect` 只能是 downstream context / mapping input / blocker explanation / manual review input。
...
- `source_owner=downstream_owner_required` 表示 WebEnvoy 不拥有该映射，只能交给下游 owner。
