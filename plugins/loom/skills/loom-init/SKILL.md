...
完整场景路由规则见 [../route-matrix.md](plugins/loom/skills/loom-init/.loom-runtime/route-matrix.md)。
...
当仓库满足 [../shared/references/adoption/lightweight-retrofit-default.md](plugins/loom/skills/loom-init/.loom-runtime/shared/references/adoption/lightweight-retrofit-default.md) 的默认条件时，判为 `小型既有仓库`。
