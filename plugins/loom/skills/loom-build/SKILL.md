...
- [spec-suite.md](plugins/loom/skills/loom-build/.loom-runtime/shared/references/templates/spec-suite.md)
- [execution-breakdown.md](plugins/loom/skills/loom-build/.loom-runtime/shared/references/templates/execution-breakdown.md)
- [task-carrier-contract.md](plugins/loom/skills/loom-build/.loom-runtime/shared/references/harness/task-carrier-contract.md)
- [evidence-map.md](plugins/loom/skills/loom-build/.loom-runtime/shared/references/templates/evidence-map.md)
- [consistency-analysis.md](plugins/loom/skills/loom-build/.loom-runtime/shared/references/templates/consistency-analysis.md)
