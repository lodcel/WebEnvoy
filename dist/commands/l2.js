...
import { buildAbilityValidationSeedForL2Result, buildL2RiskGateBlockedResultForContract, materializeCandidateAbilityFromL2SeedForContract, parseL2FirstUsableRequestForContract, parseL2FirstUsableResultForContract } from "../core/l2-first-usable.js";
...
const l2FirstUsable = async (context) => {
    ...
    try {
        ...
        const parsedResult = parseL2FirstUsableResultForContract(bridgeResult.payload.l2_first_usable_result ?? bridgeResult.payload, request);
        ...
        const materialized = materializeCandidateAbilityFromL2SeedForContract(parsedResult.candidate_shell_seed);
        return {
            l2_first_usable_result: parsedResult,
            ...materialized,
