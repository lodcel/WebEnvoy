...
const normalizeHardStopRiskSurface = (value) => {
...
const resolveObservedRiskSurface = (summary, routeEvidence, requestContext) => normalizeHardStopRiskSurface(routeEvidence?.risk_surface_classification) ??
